...
//日志服务实现类
class ModuleLog : public ModuleBase
{
	DECLARE_INSTANCE(ModuleLog);
public:
...
public:
	//保存日志函数实现
	void SvrRpcSave( int nodeId, LogRpcSaveNotify& notify);
