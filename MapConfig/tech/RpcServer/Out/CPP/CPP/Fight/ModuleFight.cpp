...
{
	MsgIdMgr::Instance().MsgRegister( this, &ModuleFight::CliRpcBulletShoot);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleFight::CliRpcStat);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleFight::CliRpcReady);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleFight::CliRpcLogin);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleFight::CliRpcSkillAction);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleFight::CliRpcSkillOper);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleFight::CliRpcSkillShotBullet);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleFight::CliRpcSkillShotTrajectoryConfig);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleFight::CliRpcInsertRoom);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleFight::CliRpcGetPlayer);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleFight::CliRpcSyncUserDir);
