...
class MatchSPVPRpcAINumNotify : public ::google::protobuf::Message {
 public:
  MatchSPVPRpcAINumNotify();
  virtual ~MatchSPVPRpcAINumNotify();

  MatchSPVPRpcAINumNotify(const MatchSPVPRpcAINumNotify& from);

  inline MatchSPVPRpcAINumNotify& operator=(const MatchSPVPRpcAINumNotify& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const MatchSPVPRpcAINumNotify& default_instance();

  void Swap(MatchSPVPRpcAINumNotify* other);

  // implements Message ----------------------------------------------

  MatchSPVPRpcAINumNotify* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const MatchSPVPRpcAINumNotify& from);
  void MergeFrom(const MatchSPVPRpcAINumNotify& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // @@protoc_insertion_point(class_scope:MatchSPVPRpcAINumNotify)
 private:
  inline void set_has_ip();
  inline void clear_has_ip();
  inline void set_has_port();
  ...
  void InitAsDefaultInstance();
  static MatchSPVPRpcAINumNotify* default_instance_;
};
// ===================================================================
...
// optional string IP = 1;
inline bool MatchSPVPRpcAINumNotify::has_ip() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void MatchSPVPRpcAINumNotify::set_has_ip() {
  _has_bits_[0] |= 0x00000001u;
}
inline void MatchSPVPRpcAINumNotify::clear_has_ip() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void MatchSPVPRpcAINumNotify::clear_ip() {
  if (ip_ != &::google::protobuf::internal::kEmptyString) {
    ip_->clear();
  }
  clear_has_ip();
}
inline const ::std::string& MatchSPVPRpcAINumNotify::ip() const {
  return *ip_;
}
inline void MatchSPVPRpcAINumNotify::set_ip(const ::std::string& value) {
  set_has_ip();
  if (ip_ == &::google::protobuf::internal::kEmptyString) {
    ip_ = new ::std::string;
  }
...
inline void MatchSPVPRpcAINumNotify::set_ip(const char* value) {
  set_has_ip();
  if (ip_ == &::google::protobuf::internal::kEmptyString) {
    ip_ = new ::std::string;
  }
...
inline void MatchSPVPRpcAINumNotify::set_ip(const char* value, size_t size) {
  set_has_ip();
  if (ip_ == &::google::protobuf::internal::kEmptyString) {
    ip_ = new ::std::string;
  }
...
inline ::std::string* MatchSPVPRpcAINumNotify::mutable_ip() {
  set_has_ip();
  if (ip_ == &::google::protobuf::internal::kEmptyString) {
    ip_ = new ::std::string;
  }
...
inline ::std::string* MatchSPVPRpcAINumNotify::release_ip() {
  clear_has_ip();
  if (ip_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
...
inline void MatchSPVPRpcAINumNotify::set_allocated_ip(::std::string* ip) {
  if (ip_ != &::google::protobuf::internal::kEmptyString) {
    delete ip_;
  }
  if (ip) {
...
// optional sint32 Port = 2 [default = -1];
inline bool MatchSPVPRpcAINumNotify::has_port() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void MatchSPVPRpcAINumNotify::set_has_port() {
  _has_bits_[0] |= 0x00000002u;
}
inline void MatchSPVPRpcAINumNotify::clear_has_port() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void MatchSPVPRpcAINumNotify::clear_port() {
  port_ = -1;
  clear_has_port();
}
inline ::google::protobuf::int32 MatchSPVPRpcAINumNotify::port() const {
  return port_;
}
inline void MatchSPVPRpcAINumNotify::set_port(::google::protobuf::int32 value) {
  set_has_port();
  port_ = value;
}

// optional sint32 SceneNum = 3 [default = 0];
inline bool MatchSPVPRpcAINumNotify::has_scenenum() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void MatchSPVPRpcAINumNotify::set_has_scenenum() {
  _has_bits_[0] |= 0x00000004u;
}
inline void MatchSPVPRpcAINumNotify::clear_has_scenenum() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void MatchSPVPRpcAINumNotify::clear_scenenum() {
  scenenum_ = 0;
  clear_has_scenenum();
}
inline ::google::protobuf::int32 MatchSPVPRpcAINumNotify::scenenum() const {
  return scenenum_;
}
inline void MatchSPVPRpcAINumNotify::set_scenenum(::google::protobuf::int32 value) {
  set_has_scenenum();
  scenenum_ = value;
}
