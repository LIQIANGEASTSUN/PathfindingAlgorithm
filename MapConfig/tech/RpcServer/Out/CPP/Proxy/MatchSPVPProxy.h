...
public:
	...
	//报告AI状态调用
	int AINum( INT64 hintId, MatchSPVPRpcAINumNotify& notify);
	int AINum( const string& hintStr, MatchSPVPRpcAINumNotify& notify);
...
public:
	...
	//报告AI状态调用
	int AINum( MatchSPVPRpcAINumNotify& notify);
...
public:
	...
	//报告AI状态调用
	int AINum( const TStr& nodeName, MatchSPVPRpcAINumNotify& notify);
