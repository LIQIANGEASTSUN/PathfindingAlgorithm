...
int MatchSPVPCarpProxy::AINum( INT64 hintId, MatchSPVPRpcAINumNotify& notify)
{
	return RpcCall(21,2, RPC_CALL_MODE_CARP, nullptr, hintId, "", &notify);
}
int MatchSPVPCarpProxy::AINum( const string& hintStr, MatchSPVPRpcAINumNotify& notify)
{
	return RpcCall(21,2, RPC_CALL_MODE_CARP, nullptr, 0, hintStr, &notify);
}
...
int MatchSPVPRandProxy::AINum( MatchSPVPRpcAINumNotify& notify)
{
	return RpcCall(21,2, RPC_CALL_MODE_RANDOM, nullptr, 0, "", &notify);
}
...
int MatchSPVPRoundProxy::AINum( MatchSPVPRpcAINumNotify& notify)
{
	return RpcCall(21,2, RPC_CALL_MODE_ROUND, nullptr, 0, "", &notify);
}
...
int MatchSPVPAppointProxy::AINum( const TStr& nodeName, MatchSPVPRpcAINumNotify& notify)
{
	return RpcCall(21,2, RPC_CALL_MODE_APPOINT, nodeName, 0, "", &notify);
}
...
int MatchSPVPConsistencyProxy::AINum( MatchSPVPRpcAINumNotify& notify)
{
	return RpcCall(21,2, RPC_CALL_MODE_CONSISTENCY, nullptr, 0, "", &notify);
}
